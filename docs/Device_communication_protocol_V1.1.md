...
**nodes** содержит в себе структуру описывающую состояние узлов агента. Примером узла может служить захват, у которого есть статус "октрыт" или "закрыт", либо узлом может быть состояние местоположения объекта. Например:
