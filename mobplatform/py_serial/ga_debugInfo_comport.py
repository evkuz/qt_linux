...
# Для последующего применения ГА введены дополнительные параметры :
# - parcelSize - определяет размер посылки в байтах от Ардуино
# - counter - число циклов запуска платформы.
