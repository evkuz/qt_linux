...
from iqrdevice.utils.vision import OpenCVCamera, BaseDetector


class GetObjectPositionService(BaseService):
    def __init__(self, cam:OpenCVCamera, detector:BaseDetector):
