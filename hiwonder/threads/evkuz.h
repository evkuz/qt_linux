 ...
 * //+++++++++++++++++++++++++++++++++++++++
 * 29.08.2022
 * Разобраться, откуда берется движение "обратно"
 *
 * //+++++++++++++++++++++++++++++++++++++++
 * 28.02.2022
 * Подошла новая задача :
 * - Добавить управление роботом HiWonder через ЦУП !
 *
 * Задача подразумевает работу с ЦУП по новому протоколу, где все сообщения в JSON-формате, см.
 * https://git.jinr.ru/jony/iqr_lit/-/blob/master/docs/Device_communication_protocol_V1.0.md
 * Т.е., например, на запрос статуса нужно будет отвечать списком action_list и т.д.
 *
 *
 *
 * //+++++++++++++++++++++++++++++++++++++++
 * 10.02.2022
 * В каждую базу знаний надо добавлять инициализаторы, в самом конце вместо {0}
 *
 *
 * // float input data
 ...
 * //+++++++++++++++++++++++++++++++++++++++
 * 09.02.2022
 * По ошибке использовал переменную HiWonder::DOF вместо HiWonder::szData.
 * Из-за этого процессор в Arduino не мог распознать полученные данные....
 * Исправил.
 *
 *
 * //++++++++++++++++++++++++++++++++++++
 ...
 * + Соответственно переименовать слот &QSimpleServer::Write_2_Client_SLot в Write_2_TcpClient_Slot
   ...
   + Заменить (18 замен) переменную parcel_size на аналогичную из класса HiWonder - HiWonder::szData
