...
public:
    //Конструктор
    //explicit QSimpleServer(const QMetaObject* ptrMainProcess,  QObject *parent = nullptr);
    explicit QSimpleServer(QObject* ptrMainProcess,  QObject *parent = nullptr);
