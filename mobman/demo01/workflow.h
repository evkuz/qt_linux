 ...
 * Философский вопрос
 *
 * В быстром ответе на запуск экшена поле
 * "rc": "int - request result code", - это тот же код, что и
 * в поле action_list: [{"result": "..."} в ответе на запрос статуса ???
 * там значится "action result code"
 *
 *
 *
