 ...
 * придет все сообщение от CV, т.е. это где-то ... байт
 * т.к. сейчас ответ от CV идет 3-мя пачками :
 * - "HTTP/1.0 200 OK" или "HTTP/1.1 200 OK" ?
 * - HTTP Заголовки
 * - Само сообщение в JSON-формате.
 * Т.е. нужно посчитать размер (17+заголовки) -> переменная okAndHeaders ->  байт и обрабатывать
