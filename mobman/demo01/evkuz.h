 ...
 * Поэтому, для сохранения адреса объекта, вызвавшего запрос к CV через сокет в ф-ции MainProcess::request_CV(),  - сделано
 ...
 * ...
 * Также пока только 7 раз подряд без сбоев сработало взятие кубика.
